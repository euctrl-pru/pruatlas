...
![A map of Germany's FIR's area at flight level
300](reference/figures/README-lf-fir-1.png)![A map of Germany's ANSP's
area at flight level 300](reference/figures/README-lf-fir-2.png)
...
![A map of all EUROCONTROL Member States' merged FIR's at flight level
200](reference/figures/README-euctrl-ms-1.png)

Lower level functions or datasets include for example `countries50m`,
the Simple Feature for the whole world countries or
[`extent_fir()`](https://pruatlas.ansperformance.eu/reference/extent_fir.md)
to calculate the bounding box of a country FIR.
...
GeoJSON which can be read as {`sf`} features via
...
(ES’s) in order to be able to plot single ES or ACC’s
